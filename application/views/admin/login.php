...
<body>
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url('<?= base_url() ?>public/images/bg-login1.jpg')">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" method="POST"
                        ...
                        <?php if(count($this->session->flashdata()) > 0): ?>
                            <?php if($this->session->flashdata('type') == 'success'): ?>
                                <strong><div class="alert alert-success text-center"><?= $this->session->flashdata('message') ?></div></strong>
                            <?php else: ?>
                    ...
                    <form class="form-horizontal" id="recoverform"
                        action="https://www.wrappixel.com/demos/admin-templates/monster-admin/main/index.html">
                        <div class="form-group ">
                            <div class="col-xs-12">
