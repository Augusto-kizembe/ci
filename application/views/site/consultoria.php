    ...
    <div class="row d-flex">
      ...
      <div class="col-md-7 wrap-about pr-md-4 ftco-animate">
        ...
        <form action="<?= base_url() ?>solicitacao/consultoria" method="POST" class="bg-light p-5 contact-form">
          ...
          <div class="form-group">
            <input type="text" name="tipo_negocio" class="form-control" required placeholder="Tipo de Negocio" value="<?=set_value('tipo_negocio')?>">
          </div>
          <div class="form-group">
            <textarea name="objectivo" id="" cols="30" rows="7" class="form-control" placeholder="Objectivo" value="<?=set_value('objectivo')?>"></textarea>
          </div>
