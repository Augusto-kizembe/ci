  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        <h1 class="mb-2 bread"><?= ($this->session->userdata('idioma') != NULL)?lang('menu_projecto'):" Projetos"; ?></h1>
        <p class="breadcrumbs"><span class="mr-2"><a href="{{ url('/') }}"><?= ($this->session->userdata('idioma') != NULL)?lang('menu_home'):" Principal"; ?> <i
                class="ion-ios-arrow-forward"></i></a></span> <span>Projetos <i
...
<section class="ftco-section bg-light">
  <div class="container">
    <h1 class="text-center">Conheça Nossos Principais Projetos</h1>
    <div class="row">
        ...
        <div class="blog-entry">
          ...
          <div class="text bg-white p-4">
            ...
            <div class="d-flex align-items-center mt-4">
              <p class="mb-0"><a href="#" class="btn btn-primary">Ler mais <span
